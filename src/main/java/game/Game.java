...
public class Game {
	public static void main(String[] args) throws InterruptedException {
		...
		for (Entry<String, Integer> manager : managers.entrySet()) {
			...
			switch (manager.getValue()) {
			case 0:
				cms.createComponent(manager.getKey(), "agents.DummyManagerBDI.class", null).getFirstResult();
				break;
			case 1:
				cms.createComponent(manager.getKey(), "agents.IntermediateManagerBDI.class", null).getFirstResult();
				break;
		...
		for (Entry<String, Integer> investor : investors.entrySet()) {
			...
			// CreationInfo cInfo1 = new CreationInfo(agentArgs1);
			switch (investor.getValue()) {
			case 0:
				cms.createComponent(investor.getKey(), "agents.DummyInvestorBDI.class", null).getFirstResult();
				break;
			case 1:
				cms.createComponent(investor.getKey(), "agents.IntermediateInvestorBDI.class", null).getFirstResult();
				break;
			}
